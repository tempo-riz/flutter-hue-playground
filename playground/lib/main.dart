...
const String clientId = "7lvGSy1S32ZhP5fAJK1tCO3WNusr1F74";
const String clientSecret = "RgMGoxgLd9H2p8fj";
const String redirectUri = "playground://auth";
...
class _HomePageState extends State<HomePage> {
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: fetchSavedBridges,
                    child: const Text("Fetch saved Bridges"),
                  ),
                  Visibility(
  ...
  Future<void> fetchSavedBridges() async {
    ...
    bridge = (await BridgeDiscoveryRepo.fetchSavedBridges()).first;
    print(bridge);
    setState(() {
      isLoading = false;
    });
